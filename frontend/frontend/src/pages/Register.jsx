        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 px-4">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-white">Join SyncRoom</h1>
                    <p className="text-gray-400 mt-2">Create your account to start meetings</p>
                </div>
                ...
                <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl shadow-xl border border-gray-700/50 p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-3 px-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-purple-500/25 transition-all disabled:opacity-50"
                        >
                ...
                <p className="text-center text-gray-600 text-xs mt-6">© 2024 Therayu. All rights reserved.</p>
            </div>
        </div>
    );
};
