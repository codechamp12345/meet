        ...
        <div className="h-screen bg-gray-900 flex flex-col overflow-hidden">
            <header className="bg-gray-800/80 border-b border-gray-700/50 px-4 py-3 flex items-center justify-between">
                <div className="flex items-center space-x-4">
                    ...
                    <button onClick={copyCode} className="flex items-center space-x-2 px-3 py-1.5 bg-gray-700/50 rounded-lg hover:bg-gray-700 cursor-pointer">
                        <span className="text-gray-400 text-sm hidden xs:inline">Code:</span>
                        <span className="text-white text-sm font-mono select-text">{meetingId}</span>
